"""Create the Prompt #01 evidence zip in the shared Score_Leads evidence directory."""
...
ZIP_TARGET = Path(r"D:\AI-Apps-In-Drive\App_Station\Score_Leads\Evidence\PROMPT#01.zip")
MANDATORY_PATHS = [
    "README.md",
    "AGENT_GUIDE.md",
